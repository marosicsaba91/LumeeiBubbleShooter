...
namespace BubbleShooterKit
{
    ...
    public class LevelInfo : ScriptableObject
    {
        ...
        public bool IsBoosterAvailable(PurchasableBoosterBubbleType booster) => booster switch
        {
            PurchasableBoosterBubbleType.SuperAim => IsSuperAimAvailable,
            PurchasableBoosterBubbleType.RainbowBubble => IsRainbowBombAvailable,
            PurchasableBoosterBubbleType.HorizontalBomb => IsHorizontalBombAvailable,
            PurchasableBoosterBubbleType.CircleBomb => IsCircleBombAvailable,
            _ => false
        };
    }
}
